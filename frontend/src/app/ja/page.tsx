...
export default function JapaneseHomePage() {
  ...
  const categories = [
    { name: "総合", href: "/ja/search/?q=総合", icon: "🛍️" },
    { name: "ファッション", href: "/ja/search/?q=ファッション", icon: "👕" },
    { name: "食品", href: "/ja/search/?q=食品", icon: "🍎" },
    { name: "アウトドア・釣り・旅行用品", href: "/ja/search/?q=アウトドア", icon: "🏕️" },
    { name: "ダイエット・健康グッズ", href: "/ja/search/?q=健康", icon: "💪" },
    { name: "コスメ・美容・ヘアケア", href: "/ja/search/?q=美容", icon: "💄" },
    { name: "スマホ・タブレット・パソコン", href: "/ja/search/?q=デジタル", icon: "📱" },
    { name: "テレビ・オーディオ・カメラ", href: "/ja/search/?q=家電", icon: "📺" },
    { name: "家電", href: "/ja/search/?q=家電", icon: "🔌" },
    { name: "家具・インテリア用品", href: "/ja/search/?q=インテリア", icon: "🪑" },
    { name: "花・ガーデニング用品", href: "/ja/search/?q=ガーデニング", icon: "🌻" },
    { name: "キッチン・日用品・文具", href: "/ja/search/?q=キッチン", icon: "🍴" },
    { name: "DIY・工具", href: "/ja/search/?q=DIY", icon: "🔧" },
    { name: "ペット用品・生き物", href: "/ja/search/?q=ペット", icon: "🐶" },
    { name: "楽器・手芸・コレクション", href: "/ja/search/?q=趣味", icon: "🎸" },
    { name: "ゲーム・おもちゃ", href: "/ja/search/?q=ゲーム", icon: "🎮" },
    { name: "ベビー・キッズ・マタニティ", href: "/ja/search/?q=ベビー", icon: "👶" },
    { name: "スポーツ用品", href: "/ja/search/?q=スポーツ", icon: "⚽" },
    { name: "車・バイク・自転車", href: "/ja/search/?q=自動車", icon: "🚗" },
    { name: "CD・音楽ソフト", href: "/ja/search/?q=音楽", icon: "🎵" },
    { name: "DVD・映像ソフト", href: "/ja/search/?q=映像", icon: "📀" },
    { name: "本・雑誌・コミック", href: "/ja/search/?q=本", icon: "📚" },
  ];
